...
function SingleBeer() {
  ...
  <path d="M6.5 14.5v-3.505c0-.245.25-.495.5-.495h2c.25 0 .5.25.5.5v3.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5Z"/>
          ...
          <div className="mt-2"><img alt="" src={`${beer.image_url}`} style = {{height:"16rem"}}/></div>
          <Card.Body>
            ...
            <Card.Subtitle className="text-start d-flex justify-content-between text-secondary mb-4">{beer.tagline} <strong className="text-dark">{beer.first_brewed}</strong></Card.Subtitle>  <Card.Text>
              {beer.description}
            </Card.Text>
